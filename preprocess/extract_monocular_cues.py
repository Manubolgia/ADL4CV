...
parser.set_defaults(omnidata_path='/home/pavkovic/omnidata/omnidata_tools/torch/')

parser.add_argument('--pretrained_models', dest='pretrained_models', help="path to pretrained models")
parser.set_defaults(pretrained_models='/home/pavkovic/omnidata/omnidata_tools/torch/pretrained_models/')
...
#trans_topil = transforms.Compose([transforms.Resize(800), transforms.ToPILImage()])
